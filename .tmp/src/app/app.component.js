...
var ConferenceApp = (function () {
    function ConferenceApp(events, userData, menu, platform, confData, storage, splashScreen) {
        ...
        this.loggedOutPages = [
            ...
            { title: 'Inscription', name: 'SignupPage', component: SignupPage, icon: 'person-add' }
        ];
